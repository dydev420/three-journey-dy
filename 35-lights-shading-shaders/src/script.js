...
pointLight1Helper.material.color.setRGB(1.0, 0.1, 0.1);
pointLight1Helper.position.set(0.0, 2.5, 0.0);
...
pointLight2Helper.material.color.setRGB(0.1, 1.0, 0.5);
pointLight2Helper.position.set(2.0, 2.0, 2.0);
