...
gui.add(sliceUniforms.uSliceStart, 'value', -Math.PI, Math.PI, 0.001).name('uSliceStart');
gui.add(sliceUniforms.uSliceArc, 'value', 0, Math.PI * 2, 0.001).name('uSliceArc');
...
const sliceMaterial = new CustomShaderMaterial({
    ...
    silent: import.meta.env.PROD && true,
