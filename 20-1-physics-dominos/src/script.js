...
import generateSnowflake from './patterns/snowflake';
...
const tick = () =>
{
    ...
    // Test update mesh
    if(objectsToUpdate[0]) {
        // objectsToUpdate[0].body.position.x += 0.01;
        // objectsToUpdate[0].body.position.z += (Math.random() - 0.5) * 0.2;
